...
beyond-$4$-cycle structure that the full assignment freedom can. The literature
method thus spans the naive and structural tiers but never enters the
FER-optimized tier---exactly the gap that motivates searching the full
edge-spreading space.
