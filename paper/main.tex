...
To put error bars on the rate-sweep ordering we re-ran four cells with $5$
independent seeds each (mean FER\,$\pm$\,$95\%$ CI, Student-$t$, large
independent re-test): at $R{=}0.479$ ($2.0$\,dB) RL-feature
$0.163\pm0.093$, CEM $0.125\pm0.019$, random $0.137\pm0.028$; at $R{=}0.692$
($2.5$\,dB) $0.488\pm0.046$, $0.415\pm0.035$, $0.458\pm0.049$; at $R{=}0.770$
($3.0$\,dB) $0.357\pm0.016$, $0.343\pm0.021$, $0.372\pm0.032$; and at
$R{=}0.906$ ($4.5$\,dB) $0.171\pm0.030$, $0.173\pm0.010$, $0.194\pm0.024$. At
these mid-scale rate cells, under a generous budget, RL, CEM and random search
are \emph{statistically indistinguishable} (overlapping CIs), CEM is often the
best single point, and RL does \emph{not} significantly beat random search
(paired RL-vs-random sign test $3/5$, $2/5$, $4/5$, $4/5$ wins;
$p{=}1.0$, $1.0$, $0.375$, $0.375$). The honest reading is the one the rest of
the paper makes: \emph{all} the FER-optimizers are comparable and \emph{all}
decisively beat the naive/default baselines, while RL's specific edge over
random search is reserved for the long-code/large-$w$/expensive-evaluation regime
(C3; Table~\ref{tab:ci}, Sections~\ref{sec:results-bigw}--\ref{sec:results-wproxy}),
not these cells. Two of the cells ($R{=}0.692$, $R{=}0.770$) sit higher on the
waterfall (operating FER $0.36$--$0.49$), an intrinsically harder, noisier
operating point at which the optimizer ordering is least separable.
